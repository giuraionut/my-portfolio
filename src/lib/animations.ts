...
const defaultEase: Easing | Easing[] = [0.25, 0.1, 0.25, 1];
...
export const popIn = ({
  ...
  visible: {
    opacity: 1,
    scale: endScale,
    transition: { type: 'spring' as const, delay, stiffness, damping },
  },
...
export const spring = ({
  ...
  exit: { opacity: 0, scale: startScale, transition: { type: 'spring' as const, stiffness, damping } },
});
...
export const wordVariants = ({
  ...
  hidden: {
    opacity: 0,
    y: distance,
    transition: { type: 'spring' as const, damping, delay },
  },
  visible: {
    opacity: 1,
    y: 0,
