...
import { ContentSection, PersonalInfo, Project as UIProject, Skill as UISkill, SocialLink } from '@/types'
...
const mapContentSection = (section: { title?: string | null, shortDescription?: string | null, bodies?: { text?: string | null }[] | null, description?: string | null, longDescription?: string | null } | null | undefined): ContentSection => {
  ...
  return {
    title: section.title,
    shortDescription: section.shortDescription,
    bodies: section.bodies?.map(b => b.text || '') || (section.description ? [section.description] : []),
  }
}
