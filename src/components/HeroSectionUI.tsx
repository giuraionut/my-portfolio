      ...
      <div className="w-full md:w-1/2 text-center md:text-left mb-10 md:mb-0">
        ...
        <MotionContainer animation="popIn">
          <div className="mt-8 flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
            <MotionContainer animation="popIn">
              <div>
                <Button size="lg" className="group cursor-pointer" onClick={scrollToProjects}>
                  View My Work
            ...
            <div className="w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 relative">
              {avatarUrl ? (
                <Image
                  ...
                  alt={name}
                  fill
                  className="w-full h-full rounded-full bg-gradient-to-r from-indigo-500 to-blue-500 dark:from-indigo-600 dark:to-blue-600 overflow-hidden p-1 object-cover"
                />
              ) : (
